        ...
        <View style={styles.cardFooter}>
          ...
          >
            <View
              style={[
                styles.downloadIcon,
                item.isSaved && styles.downloadIconSaved,
              ]}
            >
              {item.isSaved ? (
  ...
  if (filteredStatuses.length === 0 && !loading) {
    return (
      <View style={styles.emptyContainer}>
        <Icon name="inbox" size={64} color="#8696A0" style={styles.emptyIcon} />
        <Text style={styles.emptyText}>No {mediaFilter} found</Text>
      ...
      <FlatList
        ...
        refreshControl={
          <RefreshControl
            ...
            colors={["#00A884"]}
            tintColor="#00A884"
            progressBackgroundColor="#1C2C33"
          />
        }
      />
      <StatusViewer
